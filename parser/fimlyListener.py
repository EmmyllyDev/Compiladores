...
class fimlyListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by fimlyParser#bloco.
    def enterBloco(self, ctx:fimlyParser.BlocoContext):
        pass

    # Exit a parse tree produced by fimlyParser#bloco.
    def exitBloco(self, ctx:fimlyParser.BlocoContext):
        pass
