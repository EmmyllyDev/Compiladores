...
public interface fimlyListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link fimlyParser#declaracoes}.
	 * @param ctx the parse tree
	 */
	void enterDeclaracoes(fimlyParser.DeclaracoesContext ctx);
	/**
	 * Exit a parse tree produced by {@link fimlyParser#declaracoes}.
	 * @param ctx the parse tree
	 */
	void exitDeclaracoes(fimlyParser.DeclaracoesContext ctx);
	/**
	 * Enter a parse tree produced by {@link fimlyParser#declaracao_var}.
	 * @param ctx the parse tree
	 */
	void enterDeclaracao_var(fimlyParser.Declaracao_varContext ctx);
	/**
	 * Exit a parse tree produced by {@link fimlyParser#declaracao_var}.
	 * @param ctx the parse tree
	 */
	void exitDeclaracao_var(fimlyParser.Declaracao_varContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link fimlyParser#comando}.
	 * @param ctx the parse tree
	 */
	void enterComando(fimlyParser.ComandoContext ctx);
	/**
	 * Exit a parse tree produced by {@link fimlyParser#comando}.
	 * @param ctx the parse tree
	 */
	void exitComando(fimlyParser.ComandoContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link fimlyParser#fator_logico}.
	 * @param ctx the parse tree
	 */
	void enterFator_logico(fimlyParser.Fator_logicoContext ctx);
	/**
	 * Exit a parse tree produced by {@link fimlyParser#fator_logico}.
	 * @param ctx the parse tree
	 */
	void exitFator_logico(fimlyParser.Fator_logicoContext ctx);
	/**
